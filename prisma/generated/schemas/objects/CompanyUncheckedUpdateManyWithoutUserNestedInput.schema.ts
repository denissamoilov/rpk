...
const Schema: z.ZodType<Prisma.CompanyUncheckedUpdateManyWithoutUserNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => CompanyUpsertWithWhereUniqueWithoutUserInputObjectSchema,
          ),
          z
            .lazy(
              () => CompanyUpsertWithWhereUniqueWithoutUserInputObjectSchema,
      ...
      update: z
        .union([
          z.lazy(
            () => CompanyUpdateWithWhereUniqueWithoutUserInputObjectSchema,
          ),
          z
            .lazy(
              () => CompanyUpdateWithWhereUniqueWithoutUserInputObjectSchema,
...
export const CompanyUncheckedUpdateManyWithoutUserNestedInputObjectSchema =
  Schema;
