...
const Schema: z.ZodType<Prisma.ExpenseUncheckedUpdateManyWithoutCompanyNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      updateMany: z
        .union([
          z.lazy(
            () => ExpenseUpdateManyWithWhereWithoutCompanyInputObjectSchema,
          ),
          z
            .lazy(
              () => ExpenseUpdateManyWithWhereWithoutCompanyInputObjectSchema,
...
export const ExpenseUncheckedUpdateManyWithoutCompanyNestedInputObjectSchema =
  Schema;
