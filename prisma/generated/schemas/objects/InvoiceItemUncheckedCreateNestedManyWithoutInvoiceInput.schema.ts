...
const Schema: z.ZodType<Prisma.InvoiceItemUncheckedCreateNestedManyWithoutInvoiceInput> =
  z
    .object({
      create: z
        .union([
...
export const InvoiceItemUncheckedCreateNestedManyWithoutInvoiceInputObjectSchema =
  Schema;
