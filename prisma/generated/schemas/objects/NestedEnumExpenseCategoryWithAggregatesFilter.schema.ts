...
const Schema: z.ZodType<Prisma.NestedEnumExpenseCategoryWithAggregatesFilter> =
  z
    .object({
      ...
      not: z
        .union([
          z.lazy(() => ExpenseCategorySchema),
          z.lazy(
            () => NestedEnumExpenseCategoryWithAggregatesFilterObjectSchema,
          ),
        ])
        .optional(),
      _count: z.lazy(() => NestedIntFilterObjectSchema).optional(),
      _min: z
        .lazy(() => NestedEnumExpenseCategoryFilterObjectSchema)
        .optional(),
      _max: z
        .lazy(() => NestedEnumExpenseCategoryFilterObjectSchema)
        .optional(),
...
export const NestedEnumExpenseCategoryWithAggregatesFilterObjectSchema = Schema;
