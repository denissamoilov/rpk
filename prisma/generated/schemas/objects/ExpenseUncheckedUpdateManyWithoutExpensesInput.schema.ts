...
const Schema: z.ZodType<Prisma.ExpenseUncheckedUpdateManyWithoutExpensesInput> =
  z
    .object({
      id: z
        .union([
      ...
      category: z
        .union([
          ...
          z.lazy(
            () => EnumExpenseCategoryFieldUpdateOperationsInputObjectSchema,
          ),
        ])
        .optional(),
      amount: z
...
export const ExpenseUncheckedUpdateManyWithoutExpensesInputObjectSchema =
  Schema;
