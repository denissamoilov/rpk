...
const Schema: z.ZodType<Prisma.CompanyUncheckedCreateNestedManyWithoutUserInput> =
  z
    .object({
      create: z
        .union([
...
export const CompanyUncheckedCreateNestedManyWithoutUserInputObjectSchema =
  Schema;
