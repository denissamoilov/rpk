...
const Schema: z.ZodType<Prisma.InvoiceUpdateManyWithWhereWithoutCompanyInput> =
  z
    .object({
      ...
      data: z.union([
        ...
        z.lazy(
          () => InvoiceUncheckedUpdateManyWithoutInvoicesInputObjectSchema,
        ),
      ]),
    })
    .strict();

export const InvoiceUpdateManyWithWhereWithoutCompanyInputObjectSchema = Schema;
