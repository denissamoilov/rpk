...
const Schema: z.ZodType<Prisma.InvoiceUpdateManyWithoutCompanyNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => InvoiceUpdateManyWithWhereWithoutCompanyInputObjectSchema),
        z
          .lazy(() => InvoiceUpdateManyWithWhereWithoutCompanyInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const InvoiceUpdateManyWithoutCompanyNestedInputObjectSchema = Schema;
